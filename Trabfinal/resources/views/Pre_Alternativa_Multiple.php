    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Crear una pregunta de alternativa multiple</h3>
        </div>
        <div class="box-body">
          ...
          <form action="#" method="post">
            <div class="input-group">
              ...
              <!----------------------------------------------------------------->
              <div>Plantear la pregunta</div>
              <textarea id="Pregunta" rows="1" cols="50"></textarea>
              <div>&nbsp;</div>
              
              <!----------------------------------------------------------------->
              <div>Plantee las respuestas</div>
              ...
              <input type="radio" name="Presolver" value="php"></br>
              <!---->
              <textarea id="Respuesta3" rows="1" cols="50"></textarea>
              <input type="radio" name="Presolver" value="php"></br>
              <!---->
              <textarea id="Respuesta4" rows="1" cols="50"></textarea>
              <input type="radio" name="Presolver" value="php"></br>
