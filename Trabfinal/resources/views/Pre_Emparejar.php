    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Crear una pregunta de tipo Emparejamiento</h3>
        </div>
        <div class="box-body">

          <form action="#" method="post">
            <div class="input-group">
              <short>El sistema ya se encargara de que sea random</short>
              <!----------------------------------------------------------------->
              <div>
              <o2>
              <textarea id="Pregunta" rows="2" cols="40" placeholder="Afirmacion"></textarea>
              <textarea id="Pregunta" rows="2" cols="40" placeholder="Respuesta"></textarea>
              </o2>
              <div>
              &nbsp;
              <!----------------------------------------------------------------->
