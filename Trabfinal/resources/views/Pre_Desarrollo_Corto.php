    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Crear una pregunta desarrollo corto</h3>
        </div>
        <div class="box-body">
          ...
          <form action="#" method="post">
            <div class="input-group">
              <!----------------------------------------------------------------->
              <div>Plantear pregunta</div>
              <textarea id="Pregunta" rows="1" cols="50"></textarea>
              &nbsp;
              <div>Solucion de la pregunta</div>
              <textarea id="Pregunta" rows="1" cols="50"></textarea>
              &nbsp;
              <!----------------------------------------------------------------->
              <div> </div>
              <button type="button" class="btn btn-secondary">Crear Pregunta</button>
              <!----------------------------------------------------------------->
